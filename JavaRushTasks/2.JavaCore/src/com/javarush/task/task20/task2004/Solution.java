...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String haveStaticString = staticString != null ? "yes" : "no";
            String haveI = this.i != 0 ? "yes" : "no";
            String haveJ = this.j != 0 ? "yes" : "no";
            writer.println(haveStaticString);
            if(haveStaticString.equals("yes")){
                writer.println(staticString);
            }
            writer.println(haveI);
            if(haveI.equals("yes")){
                writer.println(this.i);
            }
            writer.println(haveJ);
            if(haveJ.equals("yes")){
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String haveStaticString = reader.readLine();
            ...
            String haveI = reader.readLine();
            if(haveI.equals("yes")){
                this.i = Integer.parseInt(reader.readLine());
            }
            String haveJ = reader.readLine();
            if(haveJ.equals("yes")){
